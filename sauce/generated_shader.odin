...
/*
    ...
    Cmdline:
        sokol-shdc -i sauce/shader.glsl -o sauce/generated_shader.odin -l glsl430 -f sokol_odin
...
quad_shader_desc :: proc (backend: sg.Backend) -> sg.Shader_Desc {
    ...
    case .GLCORE:
        ...
        desc.texture_sampler_pairs[1].glsl_name = "font_tex_default_sampler"
    }
    return desc
}
